...
console.log(data)
  ...
  return (
    <div className="p-8 hover:shadow-lg transition-shadow ">
        <h2 className="text-4xl font-bold text-[#252B42] text-center my-8">{res.category}</h2>
      {/* Blog Image */}
      <div className="flex justify-center">
        <Image
          ...
          width={600}
          height={400}
          className="max-w-3xl object-cover rounded-lg shadow-lg border-4 transform transition hover:scale-110 border-gray-800"
        />
      </div>

      {/* Blog Title */}
        <h1 className="text-4xl font-bold text-[#252B42] text-center my-8">{res.heading}</h1>
      <p className="text-[#252B42] text-lg text-center my-3 leading-relaxed">{res.paragrapgh}</p>
      ...
      <div className="flex items-center mt-8 space-x-4">
        ...
        />
        <div>
          <p className="text-sm text-gray-600 font-semibold">{res.author}</p>
